...
<%@ include file="../../common/menubar.jsp" %>
    <div class="outer" style="margin: auto; margin-top:50px;  margin-bottom: 50px;">
	            ...
	            <table  align="center">
	                <thead>
	                    ...
	                    <tr>
	                        <th>댓글작성</th>
	                        <td>
	                            <textarea id="replyContent" cols="50" rows="3" style="resize: none;"> 뿌아아아앙</textarea>
	                        </td>
		...
		<% if(loginUser != null && (loginUser.getMemName().equals(c.getcUserName()))){ %>
	        <button id="modiCpost" class="submitB" style=" text-align:center; margin-left:20px; width: 50px; height: 30px;  font-size:10px; background:lightgray; border: 25px; border-radius: 3px;" > 수정</button>
	        <button id="delCpost" class="submitB" style=" text-align:center; width: 50px; height: 30px;  font-size:10px; background:lightgray; border: 25px; border-radius: 3px;" > 삭제</button>
	    <%} %>
