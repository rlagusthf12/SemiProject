...
public class CatListController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		listCount = new AnimalService().selectCatCount();
		...
		ArrayList<Animal> list = new AnimalService().selectCatList(pi);
		
		request.setAttribute("pi", pi);
		request.setAttribute("list", list);
		
		
		request.getRequestDispatcher("views/animal/catListView.jsp").forward(request, response);
