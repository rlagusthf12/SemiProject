 ...
 * Generated at: 2021-06-03 17:58:12 UTC
...
public final class adoptWrittenPage_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 if(loginUser == null){ 
      ...
      out.print(contextPath);
      out.write("/insert.ad\" method=\"post\" enctype=\"multipart/form-data\">\r\n");
      ...
      out.write("                \t 제목 <input style=\"margin-right:10px;\" name=\"adoptTitle\" type=\"text\" id=\"adoptTitle\" placeholder=\"제목을 입력하세요.\" required>\r\n");
      out.write("               \t\t \r\n");
      ...
      out.write("                <br>\r\n");
      out.write("                \r\n");
      out.write("                <button onclick=\"gomainForm();\" type=\"reset\" id=\"adoptCan\" class=\"submitB\" style=\" text-align:center; width: 70px; height:25px; font-size:13px; background:lightgray; border: 25px; border-radius: 3px;\" > 취소 </button>\r\n");
      out.write("                \r\n");
      ...
      out.write("\t\t\t\t\t\t})\r\n");
      out.write("\t\t\t\t\t})\r\n");
      out.write("\t\t\t\t\tfunction gomainForm(){\r\n");
      out.write("\t\t\t\t\t\tlocation.href =\"");
      out.print(contextPath );
      out.write("/list.ad?currentPage=1\"\r\n");
      out.write("\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\r\n");
      out.write("\t\t\t\t</script>\r\n");
      out.write("\t\t\t\t<script>\r\n");
